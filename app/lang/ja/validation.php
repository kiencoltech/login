...
return [
    ...
    'required_without_all' => ':valuesのうち、どれも指定されていない場合、:attributeは必須です。',
    ...
    'double'           => ':attributeは小数点付きの値でなければいけません。',
    'numeric_array'    => ':attribute0以上の数値で入力してください',
    'color_code'       => ':attribute更新が反映されていません。再度設定をお願います。',
    'array_date'       => ':attributeは正しい日付ではありません',
